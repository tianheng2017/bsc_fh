<template>
    <div class="code-generation">
        ...
        <el-card class="!border-none mt-4" shadow="never" v-loading="pager.loading">
            <div class="flex">
                <data-table v-perms="['tools.generator/selectTable']" class="inline-block mr-[10px]"
                    @success="getLists">
                ...
                <el-button v-perms="['tools.generator/delete']" :disabled="!selectData.length"
                ...
                <el-button v-perms="['tools.generator/generate']" :disabled="!selectData.length"
                    ...
                    <el-table-column label="操作" width="120" fixed="right">
                        <template #default="{ row }">
                            <div class="flex items-center">
                                <el-button v-perms="['tools.generator/preview']" type="primary" link
                                ...
                                <el-dropdown class="ml-1">
                                    ...
                                    <template #dropdown>
                                        <el-dropdown-menu>
                                            ...
                                            <div v-perms="['tools.generator/generate']" @click="handleGenerate([row])">
                                                <el-dropdown-item>
                                                    <el-button type="primary" link>
                                                        生成代码
                                                    </el-button>
                                            ...
                                            <el-dropdown-item v-perms="['tools.generator/syncColumn']">
