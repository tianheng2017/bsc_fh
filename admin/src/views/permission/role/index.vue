                    ...
                    <el-table :data="pager.lists">
                        ...
                        <el-table-column label="操作" width="180" fixed="right">
                            <template #default="{ row }">
                                <el-button link type="primary" v-perms="['auth.role/edit']" @click="handleEdit(row)">
                                    编辑
                                </el-button>
                                <el-button link type="primary" v-perms="['auth.role/edit']" @click="handleAuth(row)">
                                    分配权限
                                </el-button>
                                <el-button v-perms="['auth.role/delete']" link type="danger"
