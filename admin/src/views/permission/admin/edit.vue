        ...
        <popup ref="popupRef" :title="popupTitle" :async="true" width="550px" :clickModalClose="true"
            ...
            <el-form ref="formRef" :model="formData" label-width="84px" :rules="formRules">
                ...
                <el-form-item label="账号" prop="account">
                    <el-input v-model="formData.account" :disabled="formData.root == 1" placeholder="请输入账号"></el-input>
                </el-form-item>
                <!-- 管理员头像 -->
                ...
                <el-form-item label="角色" prop="role_id">
                    <el-select v-model="formData.role_id" :disabled="formData.root == 1" class="flex-1"
                        ...
                        <el-option v-for="(item, index) in options.role" :key="index" :label="item.name"
